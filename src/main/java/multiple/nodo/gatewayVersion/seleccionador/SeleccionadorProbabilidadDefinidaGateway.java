...
/**
 * La clase SeleccionadorProbabilidadDefinidaGateway se encarga de realizar las iteraciones de selección de dos nodos
 * para la creación de un bloque de un tipo al azar cada 10 segundos, con 95% de probabilidad de que el bloque sea de
 * tipo 1.
 */
