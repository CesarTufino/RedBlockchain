...
public class TestV5Nodo3 {

    public static void main(String[] args) throws IOException {
        NodoTradicionalGateway nodoTradicionalGateway = new NodoTradicionalGateway(3, Direccion.DIRECCION_3); // Mi general.nodo
        ...
        for (int i = 0; i < 700; i++) {
            ...
            if (a == 1)
                nodoTradicionalGateway.enviarDinero(1.23, Direccion.DIRECCION_1.getDireccionIP());
            else
                nodoTradicionalGateway.enviarDinero(3.47, Direccion.DIRECCION_2.getDireccionIP());
            try {
                Thread.sleep(3000);
            } catch (InterruptedException e) {
