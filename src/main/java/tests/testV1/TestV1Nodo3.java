...
public class TestV1Nodo3 {

    public static void main(String[] args) throws IOException {
        NodoTradicionalPos nodoTradicionalPos = new NodoTradicionalPos(3, Direccion.DIRECCION_3);
        nodoTradicionalPos.apostar(20); // Poner el stake
        // Hilo para escuchar
        ...
        for (int i = 0; i < 700; i++) {
            ...
            if (a == 1)
                nodoTradicionalPos.enviarDinero(1.23, Direccion.DIRECCION_1.getDireccionIP());
            else
                nodoTradicionalPos.enviarDinero(3.47, Direccion.DIRECCION_2.getDireccionIP());
            try {
                Thread.sleep(3000);
            } catch (InterruptedException e) {
