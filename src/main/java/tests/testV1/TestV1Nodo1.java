...
public class TestV1Nodo1 {

    public static void main(String[] args) throws IOException {
        NodoTradicionalPos nodoTradicionalPos = new NodoTradicionalPos(1, Direccion.DIRECCION_1);
        nodoTradicionalPos.apostar(30); // Poner el stake
        // Hilo para escuchar
        Entrada hiloEntrada = new Entrada(nodoTradicionalPos);
        hiloEntrada.start();
        ...
        for (int i = 0; i < 700; i++) {
            ...
            if (a == 1)
                nodoTradicionalPos.enviarDinero(1.23, Direccion.DIRECCION_2.getDireccionIP());
            else
                nodoTradicionalPos.enviarDinero(3.47, Direccion.DIRECCION_3.getDireccionIP());
            try {
                Thread.sleep(3000);
            } catch (InterruptedException e) {
