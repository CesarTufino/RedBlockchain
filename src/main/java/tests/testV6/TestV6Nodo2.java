...
public class TestV6Nodo2 {

    public static void main(String[] args) throws IOException {
        NodoMultipleGateway nodoMultipleGateway = new NodoMultipleGateway(2, Direccion.DIRECCION_2, true);
        ...
        for (int i = 0; i < 700; i++) {
            ...
            if (a == 1)
                nodoMultipleGateway.enviarDinero(1.23, Direccion.DIRECCION_3.getDireccionIP(), Tipo.LOGICO1);
            else
                nodoMultipleGateway.enviarDinero(3.47, Direccion.DIRECCION_1.getDireccionIP(), Tipo.LOGICO2);
            try {
                Thread.sleep(3000);
            } catch (InterruptedException e) {
