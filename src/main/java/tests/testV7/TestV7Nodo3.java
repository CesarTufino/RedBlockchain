...
public class TestV7Nodo3 {

    public static void main(String[] args) throws IOException {
        NodoMultipleGateway nodoMultipleGateway = new NodoMultipleGateway(3, Direccion.DIRECCION_3, false); // Mi general.nodo
        ...
        for (int i = 0; i < 700; i++) {
            ...
            if (a == 1)
                ...
                nodoMultipleGateway.enviarDinero(3.47, Direccion.DIRECCION_2.getDireccionIP(), Tipo.LOGICO2);
            try {
                Thread.sleep(3000);
            } catch (InterruptedException e) {
