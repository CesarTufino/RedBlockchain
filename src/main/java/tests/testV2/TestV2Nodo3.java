...
import multiple.nodo.posVersion.seleccionador.SeleccionadorMultiplePos;
...
public class TestV2Nodo3 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true){
            if (nodoMultiplePos.comprobarCantidadMinimaDeNodos()) break;
            System.out.print("");
        }
        try {
            Thread.sleep(1000);
        ...
        SeleccionadorMultiplePos hiloSeleccionadorMultiplePos = new SeleccionadorMultiplePos(nodoMultiplePos);
        hiloSeleccionadorMultiplePos.start();
        ...
        for (int i = 0; i < 700; i++) {
            ...
            if (a == 1)
                nodoMultiplePos.enviarDinero(1.23, Direccion.DIRECCION_1.getDireccionIP(), Tipo.LOGICO1);
            else
                nodoMultiplePos.enviarDinero(3.47, Direccion.DIRECCION_2.getDireccionIP(), Tipo.LOGICO2);
            try {
                Thread.sleep(3000);
            } catch (InterruptedException e) {
